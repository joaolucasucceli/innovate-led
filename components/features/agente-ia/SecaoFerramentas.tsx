...
const ferramentas: Ferramenta[] = [
  {
    ...
    parametros: [
      ...
      { nome: "conversaId", tipo: "string", obrigatorio: true, descricao: "ID da conversa ativa" },
      {
        ...
        tipo: "string",
        obrigatorio: true,
        descricao: "Informações coletadas (cumulativo — append, nunca sobrescreve)",
      },
      {
        nome: "nomeLead",
        tipo: "string",
  ...
  },
  {
    ...
    parametros: [
      ...
      { nome: "conversaId", tipo: "string", obrigatorio: true, descricao: "ID da conversa ativa" },
      {
        ...
        tipo: "string",
        obrigatorio: true,
        descricao: "Dia e horário de preferência (ex: \"Hoje às 16h\", \"Segunda às 10h\")",
      },
      {
        nome: "resumo",
        tipo: "string",
        obrigatorio: true,
        descricao: "Resumo completo da qualificação do lead",
      },
    ],
  },
]
